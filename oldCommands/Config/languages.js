...
module.exports = {
  name: "languages",
  cooldown: 0,
  description: "Thay đổi ngôn ngữ giữa Tiếng Việt và Tiếng Anh!",
  description2: 'Change language from VI - EN or EN - VI!!',
  usage2: "Ylang set <en | vi>",
  aliases: ["ngonngu", 'lang'],
  usage: `Ylanguages set + <vi | en>`,
  run: async (client, message, args) => {
    ...
    if (!args[0]) {
      ...
      if (languageToSet == "vi") {
        ...
        await message.reply('Đã set ngôn ngữ thành Tiếng Việt!')
        ...
        await message.reply('Successfully set your Server languages to English!')
