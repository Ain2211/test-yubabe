...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!cooldown) {
      ...
      if (!cooldown) {
        let errorDaily = [
          `${client.emo.fail} | **${message.author.username}**, bạn quá mệt để đi làm... Hãy quay lại sau **${used.h + `:` + used.m + `:` + used.s}s** nữa !`,
          `${client.emo.fail} | **${message.author.username}**, you're too tired too work... Please comeback after **${used.h + `:` + used.m + `:` + used.s}s**!`
        ]
