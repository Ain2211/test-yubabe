module.exports = {
  name: 'life',
  cooldown: 5000,
  description: "Cuộc sống của bạn ở Yuworld! Hãy tìm hiểu và khám phá để trở nên thành công nhé!",
  description2: 'Your life at Yuword! Let\'s find out the secret to be success and rich!',
  usage2: "Yme",
  usage: "Yme",
  aliases: ['me'],
  cderror: 'đừng vội thế chứ, bạn vừa check stat mà',
  use: 'sử dụng lệnh tiếp!!',
  cderror2: 'don\'t rush, you\'ve just check your stat',
  use2: "check again <3",
