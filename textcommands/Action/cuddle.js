...
module.exports = {
  name: "cuddle",
	description: ["Xoa đầu, vuốt ve một ai đó"],
	aliases: ["xoadau"],
	usage: ["{prefix}cuddle @tag"],
	cooldown: 300,
	category: "Action",
	canuse: "everyone",
  ...
  run: async (client, message, args) => {
    ...
    const image = await axios('https://api.waifu.pics/sfw/cuddle').then((res) =>
    ...
    const embed = new EmbedBuilder()
     .setAuthor({name: message.author.username,iconURL: message.author.avatarURL({ dynamic: true })})
      .setColor("#FF69B4")
      .setDescription(`${victim} đã được ${message.author.username} vuốt ve!!`)
      .setImage(image)
      .setTimestamp()
      .setFooter({text: word})
