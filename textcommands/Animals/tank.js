...
const animals = require('../../config/fishes.json');
...
module.exports = {
	...
	aliases: ["t", "hoca"],
	usage: ["{prefix}t", "{prefix}t"],
	cooldown: 0,
	category: "Animals",
	canuse: "everyone",
	errorcd: ["Bạn phải chờ **{time}** để check tank!", "You have to wait {time} before checking the fishtank!"],
