...
module.exports = {
  name: "zoo",
  description: ["Check xem bạn đã hunt được những con thú thú vị nào!", "Check animals you have hunted!"],
  aliases: ["z"],
  usage: ["{prefix}z", "{prefix}z"],
  cooldown: 30000,
  category: "Animals",
  canuse: "everyone",
  errorcd: ["Bạn phải chờ **{time}** để check zoo!", "You have to wait {time} before checking the zoo!"],
