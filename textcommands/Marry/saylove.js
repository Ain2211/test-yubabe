...
module.exports = {
  name: "loveyou",
  description: ["Tình cảm nồng đậm...", "Say love word to your partner!"],
  aliases: ["yeuem", 'yeuanh', 'iuem', 'iuanh', 'loveyou', 'iuxop'],
  usage: ["{prefix}iuanh", "{prefix}loveyou"],
  cooldown: 300000,
  category: "Marry",
  canuse: "everyone",
  errorcd: ["Đừng như thế! Hãy chờ **{time}** ! Nói nhiều quá phản tác dụng đấy!", "Don't rush! Wait for **{time}** ! Too many love talk can lead to broken relationship..."],
